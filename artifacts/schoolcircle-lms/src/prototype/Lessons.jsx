  ...
  return (
    <div className="s-gkp">
      <div className="s-gkp-head">
        ...
        <span className="s-gkp-src">✓ Verified from {db.sourceId} · this section · live from the database</span>
      </div>
    ...
    <div className="s-vid">
      <div className="s-vid-screen">
        <div className="s-vid-poster">
          <span className="s-vid-play"><Play size={24} fill="currentColor" /></span>
