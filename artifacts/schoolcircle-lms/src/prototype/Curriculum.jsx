...
import { Book, Paperclip, AlertTriangle, Check } from 'lucide-react';
  ...
  return (
    <>
      ...
      <div className="p-panel">
        ...
        >
          <span className="p-dropicon"><Book size={32} /></span>
      ...
      {rec && (
        <div className={`p-check${rec.ok ? ' ok' : ' bad'}`}>
          <strong>{rec.ok ? <><Check size={16} /> Hours reconcile</> : <><AlertTriangle size={16} /> Hours mismatch</>}</strong>
          <span>
      ...
      <div className="p-grid2">
        ...
        <div>
          ...
          <div className="p-panel">
            ...
            >
              <span className="p-dropicon" style={{ fontSize: '1.3em' }}><Paperclip size={24} /></span>
              ...
              <ul className="p-req">
                {inherited.map((d) => (
                  <li className="p-reqrow" key={d.id}>
                    <span style={{ fontSize: '0.8em' }}><Paperclip size={14} /></span>
