...
export async function assembleCourse(
  course,
  { grounded, notCovered, thinCoverage, resolvedObjectives, resolvedTitle, diagrams = false, pages = true },
  { modelAsk, emit } = {},
) {
    ...
    const titleNotTaught = courseTitleWordsNotTaught({ title: finalTitle, sections: usable });
