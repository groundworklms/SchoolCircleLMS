 ...
 */
export const listCourses = async ( options?: Parameters<typeof customFetch>[1]): Promise<CourseListResponse> => {
 ...
 */
export const getCourse = async (id: string, options?: Parameters<typeof customFetch>[1]): Promise<CourseResponse> => {
