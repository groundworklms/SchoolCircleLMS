...
/**
 * The upstream Rubricon/Whetstone clients default to a cloud endpoint when
 * unconfigured, so all three of their isolated variables must be set before
 * they are called. A key alone never selects a provider.
 */
