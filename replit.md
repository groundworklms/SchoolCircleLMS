...
- `artifacts/schoolcircle-lms/` — React/Vite app, root planning board, and `/prototype` flows
- `artifacts/api-server/` — Express routes under `/api`
- `PLAN.md` — live markdown source rendered by the root board
...
- `.migration-backup/` — untouched imported Vercel source retained for reference
